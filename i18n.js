...
window.LA27_I18N = (() => {
  ...
  const T = {
    ...
    es: {
      ...
      "pillar.01.body": "Todos los contactos de la base de datos se limpian, verifican y validan activamente en tiempo real.",
      "pillar.02.title": `Segmentación`,
      "pillar.02.body": "Filtramos y dirigimos tu campaña basándonos exactamente en las características y región que tu empresa necesita.",
      "pillar.03.title": `Alta Entregabilidad`,
      "pillar.03.body": "Configuración y calentamiento seguro de dominios (SPF, DKIM, DMARC) para mantener tasas de apertura superiores al 60%.",
      "pillar.04.title": `Enfoque Premium`,
      "pillar.04.body": "Redacción con enfoque de copywriting conversacional no intrusivo y adaptado al idioma local.",
      "founder.eyebrow": "Quiénes somos",
      "founder.title": `El Founder.`,
      ...
      "founder.bio": "Tim Helmes es compositor, director y creador de sistemas en Barcelona. LA 27 Marketing nació tras optimizar un sistema propio de captación B2B de alto rendimiento, el cual ahora ponemos a disposición de marcas y entretenimiento.",
    ...
    en: {
      ...
      "why.lede": "Our technical infrastructure is optimized to bypass spam filters, combining real-time contact validation and clean IP rotation to land your message directly in the primary inbox.",
      "pillar.01.title": "0% Spam / Bots",
      "pillar.01.body": "All database contacts are actively cleaned, verified, and validated in real time.",
      ...
      "pillar.03.title": "High Deliverability",
      "pillar.03.body": "Secure domain setup and warming (SPF, DKIM, DMARC) to maintain open rates above 60%.",
      "pillar.04.title": "Premium Copy",
      "pillar.04.body": "Writing with a non-intrusive conversational copywriting approach tailored to the local language.",
      ...
      "founder.bio": "Tim Helmes is a composer, director, and systems developer based in Barcelona. LA 27 Marketing was born after optimizing a proprietary high-performance B2B acquisition system, now available for brands and entertainment.",
      "founder.role": "Founder & Director — LA 27 Marketing",
